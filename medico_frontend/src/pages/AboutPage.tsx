          ...
          <div className="flex flex-col gap-10 pb-10">
            ...
            <div className="flex flex-col gap-5 md:flex-row border border-gray-400 py-10 px-5  items-start md:justify-between ">
                <div className="flex flex-col  gap-3 md:w-[280px]  text-xs">
                    <div className=" font-bold text-gray-700 text-start">EFFICIENCY</div>
                ...
                <div className="flex flex-col gap-3 md:w-[280px]   text-xs">
                    <div className="text-start font-bold text-gray-700">CONVENIENCE</div>
                    <p className="text-start">
                ...
                <div className="flex flex-col gap-3 md:w-[280px]  text-xs">
                    <div className="text-start font-bold text-gray-700">PERSONALIZATION</div>
                    <p className="text-start">
